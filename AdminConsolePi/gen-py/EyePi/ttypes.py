...
class EyePiOutput(object):
    ...
    def __init__(self, ok=False, personCollection=None, token=None, data=None,):
        self.ok = ok
...
class LoginOutputObject(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(PersonEntry)
PersonEntry.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'person', 'UTF8', None, ),  # 1
    (2, TType.DOUBLE, 'chance', None, None, ),  # 2
    (3, TType.STRING, 'image', 'BINARY', None, ),  # 3
)
all_structs.append(EyePiInput)
EyePiInput.thrift_spec = (
    None,  # 0
...
all_structs.append(ConfirmInput)
ConfirmInput.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'image', 'BINARY', None, ),  # 1
    (2, TType.STRING, 'person', 'UTF8', None, ),  # 2
)
all_structs.append(EyePiOutput)
EyePiOutput.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'ok', None, False, ),  # 1
    (2, TType.LIST, 'personCollection', (TType.STRUCT, [PersonEntry, None], False), None, ),  # 2
    (3, TType.STRING, 'token', 'UTF8', None, ),  # 3
    (4, TType.MAP, 'data', (TType.I32, None, TType.STRING, 'BINARY', False), None, ),  # 4
)
all_structs.append(LoginInputObject)
LoginInputObject.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'username', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'password', 'BINARY', None, ),  # 2
    (3, TType.STRING, 'code', 'BINARY', None, ),  # 3
    (4, TType.STRUCT, 'deviceInput', [AutorisationStruct.ttypes.DeviceTokenInput, None], None, ),  # 4
    (5, TType.STRING, 'deviceToken', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'token', 'UTF8', None, ),  # 6
)
all_structs.append(LoginOutputObject)
LoginOutputObject.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'uniquename', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'details', [AutorisationStruct.ttypes.user_detail, None], None, ),  # 2
    (3, TType.STRING, 'deviceToken', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'token', 'UTF8', None, ),  # 4
    (5, TType.MAP, 'autorisations', (TType.I32, None, TType.STRUCT, [AutorisationStruct.ttypes.Autorisation, None], False), None, ),  # 5
)
