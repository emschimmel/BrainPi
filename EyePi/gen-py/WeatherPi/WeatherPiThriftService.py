...
class handleRequest_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRUCT, 'input', (WeatherPiInput, WeatherPiInput.thrift_spec), None, ),  # 1
    )
...
class handleRequest_result(object):
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (WeatherPiOutput, WeatherPiOutput.thrift_spec), None, ),  # 0
    )
